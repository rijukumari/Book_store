...
function Navbar() {
  ...
  className={`max-w-screen-2xl mx-auto px-4 sm:px-6 fixed top-0 left-0 right-0 z-50 
    ${sticky ? "shadow-md bg-base-300 dark:bg-slate-600 transition-all duration-300" : "bg-transparent"}
...
>
  <div className="navbar flex flex-wrap justify-between items-center py-2">
    ...
    <div className="flex items-center gap-2">
      ...
      {/* Logo */}
      <Link to="/" className="flex items-center gap-2 text-xl font-bold whitespace-nowrap">
    ...
    <div className="flex items-center gap-2">
      ...
      {authUser ? (
        ...
        <>
          <button
            className="bg-black text-white px-4 py-2 rounded-md hover:bg-slate-800 transition duration-300 text-sm"
