...
function Navbar() {
  ...
  const navItems = (
    <>
      <li className="pt-4 pl-48 text-lg">
        <a href="/">Home</a>
      </li>
      ...
      <div className="navbar flex flex-wrap justify-between items-center py-2">
        ...
        <div className="flex items-center gap-2">
          ...
          >
            ...
            <span className="pt-4 text-2xl">BookStore</span>
          </Link>
        </div>
        ...
        <div className="flex items-center gap-2">
          ...
          <div className="hidden md:flex items-center">
            <label className="px-3 py-2 mr-2 mt-4 border rounded-md flex items-center gap-2">
              <input
                type="search"
          ...
          {authUser ? (
            ...
            <>
              ...
              <button
                className="bg-black text-white px-4 py-2 ml-4 mt-4 rounded-md hover:bg-slate-800 transition duration-300 text-sm"
